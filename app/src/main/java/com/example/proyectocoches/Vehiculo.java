...
public class Vehiculo {
    ...
    public Vehiculo(String marca, String modelo, String combustible, String fechaMatriculacion, String km, String potencia, String ubicacion, String imagen, Double precio) {
        this.marca = marca;
        this.modelo = modelo;
